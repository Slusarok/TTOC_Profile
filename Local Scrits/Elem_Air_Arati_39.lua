...
local text = {
      ...
      {Settings = 'DoNotSellList', value = {'Rune of','传送','Hearthstone','炉石','Mining Pick','矿工锄','Skinning Knife','剥皮小刀','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Thundering Charm','Elemental Air','Aquamarine','Large Knapsack','Jade'}},
      {End = "法师不售卖"},
...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 71", End = '自定义打怪'},
            ...
            {Settings = 'BuyNPC', value = {
                  ...
                  {Id =1471  ,Path = {-1278.5726, -2521.9988, 21.3745}},
                  --修装的
                  {Id =1471  ,Path = {-1278.5726, -2521.9988, 21.3745}},
                  --弓箭商人
                  {Id =1471  ,Path = {-1278.5726, -2521.9988, 21.3745}},
            ...
            --打怪循环设置
            {AttackMonster = {2762} , Count = 1 ,  --0000,0000是要打的怪物id
            MoveTo = {--0000.0000,0000.0000,0000.0000 是要巡逻的坐标
                  {{-1213.6194, -2592.7891, 34.2318},},
	{{-1202.9183, -2630.6418, 44.8202},},
	{{-1209.5182, -2640.2451, 47.5538},},
	{{-1288.5287, -2718.9058, 49.6166},},
	{{-1321.2849, -2707.3989, 57.2306},},
	{{-1345.0332, -2705.2434, 64.1770},},
	{{-1362.0844, -2705.3914, 64.1546},},
	{{-1381.5822, -2746.8467, 55.4464},},
	{{-1374.9976, -2779.5017, 49.3418},},
	{{-1351.3793, -2789.7100, 52.1236},},
	{{-1334.0995, -2793.7822, 53.9245},},
	{{-1325.1210, -2782.5479, 56.8077},},
	{{-1313.5038, -2770.4026, 58.8423},},
	{{-1307.3464, -2759.7397, 59.7724},},
    ...
    Config:Hide()
      ...
      SetSettings({
		...
		StuckEvent = true,
            ...
            --不贩卖列表 
            DoNotSellList = {'Rune of','传送','Hearthstone','炉石','Skinning Knife','剥皮小刀','Mining Pick','矿工锄','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Thundering Charm','Elemental Air','Aquamarine','Large Knapsack','Jade'},
            --强制贩卖列表 如果需要可以自行添加
            --ForceSellList = {},
            --强制销毁
