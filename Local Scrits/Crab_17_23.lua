...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 71", End = '自定义打怪'},
            ...
            {Settings = 'BuyNPC', value = {
                  ...
                  {Id =8931  ,Path = {-10653.2793, 1166.4312, 34.4656}},
                  --修装的
                  {Id =1668  ,Path = {-10658.5264, 996.8511, 32.8750}},
                  --弓箭商人
                  {Id =491  ,Path = {-10500.6016, 1021.5914, 60.5281}},
            }},
            --是否判断回城事件
            {Settings = 'GoHomeEvent', value = true},
            --打怪循环设置
            {AttackMonster = {1216} , Count = 1 ,  --0000,0000是要打的怪物id
            MoveTo = {--0000.0000,0000.0000,0000.0000 是要巡逻的坐标
                  {{-10875.4717, 2081.9951, 13.9530},},
	{{-10879.0576, 2101.8745, 7.9314},},
	{{-10891.9238, 2106.9814, 8.5093},},
	{{-10903.5225, 2104.3813, 9.3120},},
	{{-10919.2002, 2097.9863, 9.8771},},
	{{-10936.6992, 2098.9731, 6.4719},},
