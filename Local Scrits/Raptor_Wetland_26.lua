...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 71", End = '自定义打怪'},
            ...
            {Settings = 'BuyNPC', value = {
                  ...
                  {Id =1464  ,Path = {-3827.8694, -831.9232, 10.0910}},
                  --修装的
                  {Id =1461  ,Path = {-3790.1299, -858.1258, 11.5985}},
                  --弓箭商人
                  {Id =1461  ,Path = {-3790.1299, -858.1258, 11.5985}},
            }},
            --是否判断回城事件
            ...
            --打怪循环设置
            {AttackMonster = {1023, 1022} , Count = 1 ,  --0000,0000是要打的怪物id
            MoveTo = {--0000.0000,0000.0000,0000.0000 是要巡逻的坐标
                  {{-3355.3591, -1813.1473, 24.2125},},
	{{-3383.5552, -1786.6782, 25.8537},},
	{{-3419.5847, -1774.6887, 26.0805},},
	{{-3481.1406, -1741.9843, 25.8824},},
	{{-3502.5913, -1757.5664, 21.1220},},
	{{-3512.6831, -1763.2355, 20.8264},},
