...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 71", End = '自定义打怪'},
            ...
            {Settings = 'BuyNPC', value = {
                  ...
                  {Id =9179  ,Path = {-6760.1870, -3135.5542, 241.1657}},
                  --修装的
                  {Id =9179  ,Path = {-6760.1870, -3135.5542, 241.1657}},
                  --弓箭商人
                  {Id =9179  ,Path = {-6760.1870, -3135.5542, 241.1657}},
            ...
            --打怪循环设置
            {AttackMonster = {92} , Count = 1 ,  --0000,0000是要打的怪物id
            MoveTo = {--0000.0000,0000.0000,0000.0000 是要巡逻的坐标
                  {{-7110.1328, -2955.2488, 245.1893},},
	{{-7175.7041, -3110.2751, 273.7426},},
	{{-7177.0625, -3114.9827, 272.2454},},
	{{-7240.7207, -3186.1663, 291.3765},},
	{{-7286.6631, -3174.2617, 298.1080},},
	{{-7305.0586, -3165.1809, 305.2861},},
	{{-7300.9189, -3157.8105, 307.6738},},
	{{-7300.9590, -3155.5305, 308.7205},},
	{{-7300.3115, -3155.6526, 308.5129},},
	{{-7302.4355, -3149.9292, 311.6109},},
	{{-7212.5791, -3090.9521, 301.4957},},
