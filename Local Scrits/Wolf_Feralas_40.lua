...
local text = {
      ...
      {Settings = 'DoNotSellList', value = {'Rune of','传送','Hearthstone','炉石','Mining Pick','矿工锄','Skinning Knife','剥皮小刀','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Turtle Scale','Turtle Meat','Thick Leather','Heavy Hide','Thick Hide','Black Pearl','Golden Pearl','Silksand Circlet','Turtle Scale','Turtle Meat','Thick Leather','Heavy Hide','Thick Hide','Black Pearl','Golden Pearl','Silksand Circlet','Thick Wolfhide','Thick Leather','Thick Hide','Aquamarine','Large Knapsack',"Journeyman's Backpack",3914,'Formula: Enchant Bracer - Greater Spirit','Troll-hide Bag','Star Ruby','Golden Pearl','Black Pearl','Superior Healing Potion','Greater Mana Potion','Scroll of Intellect III','Scroll of Stamina III','Formula: Enchant Shield - Stamina','Recipe: Elixir of Detect Lesser Invisibility','Recipe: Limited Invulnerability Potion','Tender Wolf Meat'}},
      {End = "法师不售卖"},

      {If = "SC:GetPlayer().Class == 'ROGUE' or SC:GetPlayer().Class == 'WARRIOR'",End = '近战不售卖' },
      {Settings = 'DoNotSellList', value = {'Rune of','传送','Hearthstone','炉石','Skinning Knife','剥皮小刀','Mining Pick','矿工锄','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Smoked Talbuk Venison','熏烤塔布羊排','Roasted Quail','烤鹌鹑','Bladespire Bagel','刀塔面圈','Clefthoof Ribs','裂蹄肋排','Homemade Cherry Pie','自制樱桃馅饼',"Mag'har Grainbread",'玛格汉面包','Turtle Scale','Turtle Meat','Thick Leather','Heavy Hide','Thick Hide','Black Pearl','Golden Pearl','Silksand Circlet'}},
      --售卖
...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 71", End = '自定义打怪'},
            ...
            {Settings = 'BuyNPC', value = {
                  ...
                  {Id =7943  ,Path = {-4509.7090, 3285.2466, 14.8586}},
                  --修装的
                  {Id =7942  ,Path = {-4379.0303, 3311.8333, 13.5522}},
                  --弓箭商人
                  {Id =7942  ,Path = {-4379.0303, 3311.8333, 13.5522}},
            }},
            --是否判断回城事件
            ...
            --打怪循环设置
            {AttackMonster = {5286} , Count = 1 ,  --0000,0000是要打的怪物id
            MoveTo = {--0000.0000,0000.0000,0000.0000 是要巡逻的坐标
                  {{-4645.8867, 3202.8386, 11.6122},},
	{{-4671.6709, 3214.9729, 11.3701},},
	{{-4682.3335, 3246.6965, 15.7112},},
	{{-4687.4146, 3273.7759, 19.0606},},
	{{-4738.7896, 3289.3120, 18.8550},},
	{{-4748.1553, 3317.5051, 20.7675},},
	{{-4732.1948, 3347.9995, 21.3475},},
	{{-4705.9814, 3365.2148, 26.7849},},
	{{-4702.2104, 3389.1599, 23.3803},},
	{{-4676.6924, 3393.0349, 26.3295},},
	{{-4658.6895, 3408.0669, 24.4036},},
	{{-4643.5093, 3420.8494, 23.3778},},
	{{-4620.8379, 3436.2048, 26.9790},},
	{{-4625.1665, 3437.4573, 26.4534},},
	{{-4613.0835, 3449.2727, 30.2309},},
	{{-4584.7393, 3463.7222, 27.4843},},
	{{-4586.5098, 3466.3252, 27.0684},},
	{{-4566.9316, 3471.2441, 28.2112},},
	{{-4543.0020, 3495.8447, 22.8639},},
    ...
    Config:Hide()
      ...
      SetSettings({
		...
		StuckEvent = true,
            ...
            --当背包空格小于等于多少时触发回城
            MinFreeBagSlotsToGoToTown = 3,
            --当装备耐久度小于等于%多少时触发回城
            MinDurabilityPercent = 20,
            --贩卖颜色等级0~8
            SellLevel = {[0] = true,[1] = true,[2] = true,},
            --不贩卖列表 
            DoNotSellList = {'Rune of','传送','Hearthstone','炉石','Skinning Knife','剥皮小刀','Mining Pick','矿工锄','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Turtle Scale','Turtle Meat','Thick Leather','Heavy Hide','Thick Hide','Black Pearl','Golden Pearl','Silksand Circlet','Thick Wolfhide','Thick Leather','Thick Hide','Aquamarine','Large Knapsack',"Journeyman's Backpack",3914,'Formula: Enchant Bracer - Greater Spirit','Troll-hide Bag','Star Ruby','Golden Pearl','Black Pearl','Superior Healing Potion','Greater Mana Potion','Scroll of Intellect III','Scroll of Stamina III','Formula: Enchant Shield - Stamina','Recipe: Elixir of Detect Lesser Invisibility','Recipe: Limited Invulnerability Potion'},
            --强制贩卖列表 如果需要可以自行添加
            --ForceSellList = {},
            --强制销毁
