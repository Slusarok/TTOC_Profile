...
local text = {
      ...
      {Settings = 'DoNotSellList', value = {'Rune of','传送','Hearthstone','炉石','Mining Pick','矿工锄','Skinning Knife','剥皮小刀','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Thick Leather','Heavy Hide','Aquamarine','Large Fang'}},
      {End = "法师不售卖"},
...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 71", End = '自定义打怪'},
            ...
            {Settings = 'BuyNPC', value = {
                  ...
                  {Id =2352  ,Path = {-857.0965, -570.7508, 11.0650}},
                  --修装的
                  {Id =13217  ,Path = {-24.1885, -321.1770, 131.1567}},
                  --弓箭商人
                  {Id =3541  ,Path = {-774.5174, -505.7457, 23.6274}},
            }},
            --是否判断回城事件
            {Settings = 'GoHomeEvent', value = true},
            --打怪循环设置
            {AttackMonster = {2250,2251} , Count = 1 ,  --0000,0000是要打的怪物id
            MoveTo = {--0000.0000,0000.0000,0000.0000 是要巡逻的坐标
                  {{89.5665, -366.0489, 144.1453},},
	{{120.2861, -346.4940, 150.3229},},
	{{136.4894, -340.2156, 147.5462},},
	{{165.2950, -296.0210, 152.1301},},
	{{165.0130, -273.2791, 152.1629},},
	{{164.7012, -275.4738, 152.2268},},
	{{171.0110, -233.9061, 154.3914},},
	{{196.6456, -240.7406, 147.1281},},
	{{198.2949, -278.4538, 148.4674},},
	{{223.1352, -298.9836, 151.4402},},
	{{233.2068, -320.8634, 155.4285},},
	{{230.6159, -335.5217, 156.3056},},
	{{229.9992, -346.3766, 161.3639},},
	{{287.1711, -400.2397, 166.7370},},
	{{308.8802, -377.8657, 169.2314},},
	{{320.6173, -370.4212, 169.6055},},
	{{342.3036, -417.7301, 171.9587},},
	{{310.4430, -463.5253, 158.6390},},
    ...
    Config:Hide()
      ...
      SetSettings({
		...
		StuckEvent = true,
            ...
            --不贩卖列表 
            DoNotSellList = {'Rune of','传送','Hearthstone','炉石','Skinning Knife','剥皮小刀','Mining Pick','矿工锄','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Thick Leather','Heavy Hide','Aquamarine','Large Fang','Large Knapsack'},
            --强制贩卖列表 如果需要可以自行添加
            --ForceSellList = {},
            --强制销毁
