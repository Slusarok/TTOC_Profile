...
local text = {
      ...
      {Settings = 'DoNotSellList', value = {'Rune of','传送','Hearthstone','炉石','Mining Pick','矿工锄','Skinning Knife','剥皮小刀','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Turtle Scale','Turtle Meat','Thick Leather','Heavy Hide','Thick Hide','Black Pearl','Golden Pearl','Silksand Circlet'}},
      {End = "法师不售卖"},
...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 71", End = '自定义打怪'},
			...
			{{-3580.0840, -4315.1050, 6.2999},},
	{{-3674.5359, -4388.4102, 10.4268},},
	{{-3652.0779, -4411.5474, 10.3394},},
	{{-3616.6980, -4436.4888, 13.3950},},
	...
	{{-3580.0840, -4315.1050, 6.2999},},
            ...
            {Settings = 'BuyNPC', value = {
                  ...
                  {Id =6272  ,Path = {-3616.1282, -4470.8159, 14.2458}},
                  --修装的
                  {Id =4889  ,Path = {-3712.4622, -4519.0986, 11.9106}},
                  --弓箭商人
                  {Id =4889  ,Path = {-3712.4622, -4519.0986, 11.9106}},
            }},
            --是否判断回城事件
            ...
            --打怪循环设置
            {AttackMonster = {4396,4399,4398,4397} , Count = 1 ,  --0000,0000是要打的怪物id
            MoveTo = {--0000.0000,0000.0000,0000.0000 是要巡逻的坐标
                  {{-3551.2100, -4342.7471, 8.8525},},
	{{-3501.2546, -4369.3096, 1.7827},},
	{{-3482.9712, -4371.5220, 1.4296},},
	{{-3469.7107, -4373.1265, 1.1789},},
	{{-3445.3132, -4370.8843, 1.6159},},
	{{-3425.5789, -4365.1128, 2.7299},},
	{{-3398.3171, -4341.4922, 3.7757},},
	{{-3374.4067, -4319.2988, 0.6172},},
	{{-3347.7009, -4297.4033, 0.8210},},
	{{-3300.8728, -4281.0005, 1.8459},},
	{{-3257.6907, -4271.7075, 1.9351},},
	{{-3216.6494, -4255.0439, 1.3963},},
	{{-3156.4595, -4219.6094, 0.3803},},
	{{-3126.5232, -4221.7974, 0.4560},},
	{{-3124.6423, -4222.3730, 0.2845},},
	{{-3122.2649, -4223.2700, 0.0135},},
	{{-3051.4177, -4201.4243, 1.7743},},
	{{-3021.7007, -4202.8169, 0.9306},},
	{{-2987.9321, -4209.1108, 1.6319},},
	{{-2931.5991, -4223.0083, 2.7662},},
	{{-2888.0593, -4224.7842, 1.8844},},
	{{-2813.4043, -4211.6826, 1.2671},},
	{{-2780.4675, -4205.4131, 1.2811},},
    ...
    Config:Hide()
      ...
      SetSettings({
		...
		StuckEvent = true,
            ...
            --不贩卖列表 
            DoNotSellList = {'4304','4235','7909','11202','Rune of','传送','Hearthstone','炉石','Skinning Knife','剥皮小刀','Mining Pick','矿工锄','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉','Turtle Scale','Turtle Meat','Thick Leather','Heavy Hide','Thick Hide','Black Pearl','Golden Pearl','Silksand Circlet'},
            --强制贩卖列表 如果需要可以自行添加
            --ForceSellList = {},
            --强制销毁
