local Bot = TTOCInitScript("Flborg_new_version")
local Log = Bot.Log
local UI = Bot.UI
...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 71", End = '自定义打怪'},
            ...
            {Settings = 'BuyNPC', value = {
                  ...
                  {Id =3961  ,Path = {2751.8430, -412.0334, 111.4591}},
                  --修装的
                  {Id =11137  ,Path = {2672.3079, -363.6043, 110.7280}},
                  --弓箭商人
                  {Id =3962  ,Path = {2717.7014, -309.6603, 110.7283}},
            }},
            --是否判断回城事件
            ...
            MoveTo = {--0000.0000,0000.0000,0000.0000 是要巡逻的坐标
                  {{2245.7495, -1276.1562, 76.5979},},
	{{2248.0845, -1297.0120, 76.5547},},
	{{2248.4028, -1310.6191, 77.6150},},
	{{2233.3728, -1330.1775, 81.0672},},
	{{2231.0300, -1339.8250, 82.0791},},
	{{2230.2805, -1363.9847, 85.6626},},
	{{2235.3235, -1383.9771, 86.1528},},
	{{2239.4521, -1393.5472, 85.9582},},
	{{2234.9119, -1396.5687, 86.1462},},
